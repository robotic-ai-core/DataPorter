            ...
            for shard_path in _shard_iterator(
                ...
                for i in range(0, len(row_order), batch_size):
                    ...
                    for future in futures:
                        ...
                        # Back-pressure: producer-side flow-balance
                        # gate — block when the producer has put more
                        # than one buffer-worth of content ahead of
                        # what the consumer has drawn.  Same semantic
                        # as the video pool's _run_spawn_pool.
